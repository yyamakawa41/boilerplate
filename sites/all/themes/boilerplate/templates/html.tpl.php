...
<!--[if (gte IE 9)|(gt IEMobile 7)]><!--><html ng-app="myApp" <?php print $html_attributes . $rdf_namespaces; ?>><!--<![endif]-->
...
<body ng-controller="myController" class="<?php print $classes; ?>" <?php print $attributes;?>>
